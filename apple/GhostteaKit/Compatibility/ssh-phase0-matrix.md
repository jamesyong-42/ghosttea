...
| Flow control   | Sustained output with bounded app queues      | Required                  | No socket/channel delivery while paused; exact 32 MiB drain; standard-tier VT whole-app gate passes                                            | Add active SSH metrics; repeat on compact-tier device |
