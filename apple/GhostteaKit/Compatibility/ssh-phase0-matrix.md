...
| Authentication | Ed25519 public key                            | Required                  | Opaque in-memory resolver passes unencrypted/encrypted keys; OpenSSL derives public key; no key paths exist        | Exercise Keychain-backed public key on device and launch-server sample |
...
| Authentication | Encrypted private-key loading                 | Required                  | Counted private-key/passphrase bytes pass directly to libssh2 memory API; wrong passphrase rejects                 | Exercise Keychain-backed flow on device and launch-server sample       |
