...
| Authentication | Ed25519 public key                            | Required                  | Nonblocking unencrypted and encrypted keys pass; opaque resolver materializes a protected temporary key            | Exercise Keychain-backed public key on device and launch-server sample |
