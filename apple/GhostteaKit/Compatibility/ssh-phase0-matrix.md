...
| Session        | Exit status/signal, EOF, half-close           | Required                  | iPhone separates streams and reports exit 37 and `SIGTERM`; half-close and close pass on macOS                    | Repeat input half-close on physical device               |
