...
| Networking     | Hostname resolution deadline and cancellation | Required                  | Apple DNS-SD resolver shares the connect deadline and 100 ms cancellation polling; package and live `localhost` fixtures pass; both iOS SDKs build | Repeat on device and against launch-server DNS           |
