...
| Host identity  | Known-hosts match, unknown host, changed host | Required                  | Strict reject, accept-once, atomic insert/replace, and strict reconnect pass               | Wire UIKit confirmation flow                              |
