...
| Host identity  | Known-hosts match, unknown host, changed host | Required                  | Strict rejection plus explicit async accept-once decisions pass                            | Wire UIKit and atomic persistent update policy            |
