...
/**
 * Main-process, control-only access to Ghosttea sessions.
 *
 ...
 * by ghosttead against accepted human input.
 */
export class GhostteaAutomationClient extends EventEmitter {
  ...
  constructor(connection: TerminalDaemonConnection, options: GhostteaAutomationClientOptions = {}) {
    super();
  ...
  #requestConnected(command: CommandPayload): Promise<ServerEvent> {
